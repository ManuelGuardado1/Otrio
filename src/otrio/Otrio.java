...
//                    Board.AddPiecePixel(x,y);
    ...
    addMouseMotionListener(new MouseMotionAdapter() {
      public void mouseMoved(MouseEvent e) {
          int x = e.getX() - Window.getX(0);
          int y = e.getY() - Window.getY(0);
          Board.MouseListener(x,y);          
//          Board.MovePiece(x,y, g);
//        System.out.println(x + " " + y);
        
//         int xcol = -e.getY() + Window.getYNormal(0);
//         int yrow = e.getX() - Window.getX(0);
                 
//         System.out.println(xcol + " " + yrow);
...
//         int xcol = -e.getY() + getYNormal(0);
//         int yrow = 0;
//                 
//        board[][]  = ptr.getChosenPiece();
//        return board[0][0];
//       }
/////////////////////////////////////////////////////////////////////////
    public void reset() {
