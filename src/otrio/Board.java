...
//      public static void MovePiece(int xpixel, int ypixel, Graphics2D g) {
//          
...
//        
//           if (pieceChosen != null)
//               if (pieceChosen.getSize() == Piece.SIZE.BIG){
//               g.setStroke(new BasicStroke(6));
//               g.setColor(pieceChosen.getColor());
//               g.drawOval(xpixel, ypixel, xdelta*5 - 10, ydelta*5 - 10) ;
//               
//               }
...
//        int column = MouseX/(xdelta);   
//        int row = MouseY/(ydelta);
...
//                        
           ...
           if (pieceChosen.getSize() == Piece.SIZE.BIG ){
               g.setStroke(new BasicStroke(6));
               g.setColor(pieceChosen.getColor());
//               g.drawOval(MouseX,  MouseY, xdelta*5 - 10, ydelta*5 - 10) ;
//               g.drawOval(Window.getX(MouseX) - Window.getY(MouseY/(ydelta)),  Window.getY(MouseY) + Window.getX(MouseX/(xdelta)), xdelta*5 - 10, ydelta*5 - 10) ;
               g.drawOval(MouseX + 20 ,  MouseY +130 , xdelta*5 - 10, ydelta*5 - 10) ;
               
               
//               g.drawOval(MouseX + 5,  MouseY + 5, xdelta*5 - 10, ydelta*5 - 10) ;
               
               }
           
              if (pieceChosen.getSize() == Piece.SIZE.MEDUIM ){
               g.setStroke(new BasicStroke(6));
               g.setColor(pieceChosen.getColor());
//               g.drawOval(MouseX,  MouseY, xdelta*5 - 10, ydelta*5 - 10) ;
//               g.drawOval(Window.getX(MouseX) - Window.getY(MouseY/(ydelta)),  Window.getY(MouseY) + Window.getX(MouseX/(xdelta)), xdelta*5 - 10, ydelta*5 - 10) ;
               g.drawOval(MouseX + 20 ,  MouseY +130 , xdelta*3 , ydelta*3 ) ;
...
//               g.drawOval(MouseX + 5,  MouseY + 5, xdelta*5 - 10, ydelta*5 - 10) ;
              ...
              if (pieceChosen.getSize() == Piece.SIZE.SMALL ){
               g.setStroke(new BasicStroke(6));
               g.setColor(pieceChosen.getColor());
//               g.drawOval(MouseX,  MouseY, xdelta*5 - 10, ydelta*5 - 10) ;
//               g.drawOval(Window.getX(MouseX) - Window.getY(MouseY/(ydelta)),  Window.getY(MouseY) + Window.getX(MouseX/(xdelta)), xdelta*5 - 10, ydelta*5 - 10) ;
               g.fillOval(MouseX + 20 ,  MouseY +130 , xdelta , ydelta ) ;
...
//    }
    ...
    public static void MouseListener(int x,int y){
        MouseX = x;
        MouseY = y;
    }
